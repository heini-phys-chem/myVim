...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
  hi Normal         ctermbg=235  ctermfg=255  guibg=#262626 guifg=#bcbcbc cterm=NONE           gui=NONE
  ...
  hi Comment          ctermbg=NONE ctermfg=247  guibg=NONE    guifg=#585858 cterm=NONE           gui=NONE
