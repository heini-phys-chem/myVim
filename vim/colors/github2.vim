...
" {{{ Syntax highlighting
hi Ignore   ctermfg=3 guifg=#808080
hi Identifier   ctermfg=88 guifg=#0086B3 gui=bold cterm=bold
"hi PreProc  ctermfg=247 guifg=#A0A0A0 gui=bold cterm=bold
hi PreProc  ctermfg=88 guifg=#A0A0A0 gui=bold cterm=bold
"hi Comment  ctermfg=246 guifg=#999988
hi Comment  ctermfg=2 guifg=#999988
hi Constant ctermfg=63 guifg=#177F80 gui=none cterm=none
"hi String   ctermfg=161 guifg=#D81745
hi String   ctermfg=21 guifg=#D81745
"hi Function ctermfg=88 guifg=#990000 gui=bold cterm=bold
hi Function ctermfg=88 guifg=#990000 gui=bold cterm=bold
"hi Statement    ctermfg=0 guifg=#000000 gui=bold cterm=bold
hi Statement    ctermfg=166 guifg=#000000 gui=bold cterm=bold
"hi Type     ctermfg=60 guifg=#445588 gui=bold   cterm=bold
hi Type     ctermfg=88 guifg=#445588 gui=bold   cterm=bold
